...
// Parse the Data
d3.csv("https://picbed-mainland.oss-cn-beijing.aliyuncs.com/year_industry.csv", function(data) {
  ...
  var mouseout = function(d) {
    ...
    Tooltip.text('1998-2021年机构主要布局行业概览')
  ...
  function jump(event, d) {
    ...
    grp = keys[d]
    // console.log(d)
    window.location.href=`detail_industry_wc.html`;
  }
  // Show the areas
  area = svg
    .selectAll("mylayers")
